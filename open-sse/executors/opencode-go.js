...
function sanitizeResponsesItems(body) {
  ...
  body.input = body.input.filter((item) => {
    ...
    // Strip prior-turn reasoning items: pooled Console credentials and sessions
    // cannot validate reasoning.encrypted_content from a different caller. With
    // store=false, missing blobs are also rejected as not found or deleted.
